...
const margin = {top: 100, right: 0, bottom: 0, left: 0},
    ...
    innerRadius = 93,
    outerRadius = Math.min(width, height) / 8.7;   // the outerRadius goes from the middle of the SVG area to the border

// append the svg object
const svg = d3.select("#DC_dataviz")
  .append("svg")
